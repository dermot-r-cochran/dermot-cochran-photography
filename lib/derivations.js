...
// src/year, src/albums, src/country, src/keywords) via
...
function groupPhotosBy(photos, keyOf) {
  ...
  for (const photo of photos) {
    // A list value (the `keywords:` field) files the photo under every
    // entry. Every other axis is single-valued: album and location are
    // exclusive by meaning, keywords overlap by meaning.
